...
//testing firbase auto saving draft
...
//     // Draft object to be saved
//     const draft = {
//         title: courseTitle,
//         description: courseDescription,
//         category: courseCategory,
//         savedAt: firebase.firestore.FieldValue.serverTimestamp() // Save timestamp
//     };

//     // Save draft in Firestore under a specific document (e.g., "drafts/adminID_courseID")
//     db.collection('drafts').doc('adminID_courseID').set(draft)
//     .then(() => {
...
// // Automatically save draft every 5 seconds (5000ms)
// setInterval(saveDraftToFirestore, 5000);

// Load draft from Firestore
// function loadDraftFromFirestore() {
//     const docRef = db.collection('drafts').doc('adminID_courseID');
...
//             document.getElementById('course-category').value = draft.category;
